...
public class AttractionsContract {
    ...
    public static final String CONTENT_AUTHORITY = PADC_WEEK6_APP.class.getPackage().getName(); // no change
    public static final Uri BASE_CONTENT_URI = Uri.parse("content://" + CONTENT_AUTHORITY);// no change (
