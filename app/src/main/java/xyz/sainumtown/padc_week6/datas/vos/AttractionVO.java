...
public class AttractionVO {
    ...
    public static void saveAttractions(List<AttractionVO> attractionList) {
        ...
        Log.d(PADC_WEEK6_APP.TAG, "Bulk inserted into attraction table : " + insertedCount);
    }
    ...
    private static void saveAttractionImages(String title, String[] images) {
        ...
        Log.d(PADC_WEEK6_APP.TAG, "Bulk inserted into attraction_images table : " + insertCount);
    }
